 ...
 * @generated
 */
public class DictionarySwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case DictionaryPackage.DICTIONARY: {
				Dictionary dictionary = (Dictionary)theEObject;
				T result = caseDictionary(dictionary);
				if (result == null) result = caseIIdElement(dictionary);
				if (result == null) result = caseINamedElement(dictionary);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DictionaryPackage.DICTIONARY_ELEMENT: {
				DictionaryElement dictionaryElement = (DictionaryElement)theEObject;
				T result = caseDictionaryElement(dictionaryElement);
				if (result == null) result = caseIIdElement(dictionaryElement);
				if (result == null) result = caseINamedCommentedElement(dictionaryElement);
				if (result == null) result = caseINamedElement(dictionaryElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DictionaryPackage.ABSOLUTE_TERM_ENTRY: {
				AbsoluteTermEntry absoluteTermEntry = (AbsoluteTermEntry)theEObject;
				T result = caseAbsoluteTermEntry(absoluteTermEntry);
				if (result == null) result = caseDictionaryElement(absoluteTermEntry);
				if (result == null) result = caseIIdElement(absoluteTermEntry);
				if (result == null) result = caseINamedCommentedElement(absoluteTermEntry);
				if (result == null) result = caseINamedElement(absoluteTermEntry);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseDictionaryElement(DictionaryElement object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Absolute Term Entry</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Absolute Term Entry</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseAbsoluteTermEntry(AbsoluteTermEntry object) {
		return null;
	}
