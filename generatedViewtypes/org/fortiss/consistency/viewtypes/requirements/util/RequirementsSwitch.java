/**
 */
package org.fortiss.consistency.viewtypes.requirements.util;
...
import org.fortiss.consistency.viewtypes.requirements.*;
...
public class RequirementsSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case RequirementsPackage.REQUIREMENT_LIST: {
				RequirementList requirementList = (RequirementList)theEObject;
				T result = caseRequirementList(requirementList);
				if (result == null) result = caseINamedCommentedElement(requirementList);
				if (result == null) result = caseINamedElement(requirementList);
			...
			case RequirementsPackage.REQUIREMENT: {
				...
				if (result == null) result = caseINamedCommentedElement(requirement);
				if (result == null) result = caseINamedElement(requirement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
