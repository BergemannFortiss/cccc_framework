...
public class ConsistencyModelElementFactory {
	...
	public static ConsistencyViewtype createConsistencyViewtypeWithLists(
		...
		for(Map.Entry<String, List<ClassFeature>> entry : classMap.entrySet()) {
			String key = entry.getKey();
			List<ClassFeature> value = entry.getValue();
	...
	public static ConsistencyViolation createInconsistencyViolation(String violationName,
		...
		ConsistencyViolationType type = ConsistencyViolationType.FOUND_INCONSISTENCY;
		String explanation =
	...
	public static ConsistencyViolation createExceptionViolation(String violationName,
		...
		ConsistencyViolationType type = ConsistencyViolationType.EXPERIENCED_EXCEPTION;
		String explanation =
	...
	public static ConsistencyViolation createBlockedViolation(String violationName,
			ConsistencyRule rule, String cause) {
		ConsistencyViolationType type = ConsistencyViolationType.BLOCKED_ACCESS;
		String explanation =
	 ...
	 *            The user token of the user.
	 * @param location
	 *            The location from wwhich the user ahs logged in.
